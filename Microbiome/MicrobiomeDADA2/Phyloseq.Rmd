...
#load physeq objects to start her 
```{r}
...
# T.test for normal data Wilcox test used for others 
```
# we found no significant differences in diversity between subejct 1 and subject 2
